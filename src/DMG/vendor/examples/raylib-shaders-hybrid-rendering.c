...
int main(void)
{
    ...
    Shader shdrRaymarch = LoadShader(0, TextFormat("assets/vendor/raylib/shaders/glsl%i/hybrid_raymarch.fs", GLSL_VERSION));

    // This Shader is a standard rasterization fragment shader with the addition of depth writing
    // You are required to write depth for all shaders if one shader does it
    Shader shdrRaster = LoadShader(0, TextFormat("assets/vendor/raylib/shaders/glsl%i/hybrid_raster.fs", GLSL_VERSION));
